...
const NavigationBar = ({ activeSection, scrollToSection }) => {
    const navItems = [
    ...
    return (
        <div className="min-h-screen bg-black text-green-400 font-mono relative overflow-hidden">
            ...
            <video
                ...
                muted
                playsInline
                className="background-video-terminal"
            >
                ...
                >
                    <div className="max-w-4xl border-2 border-green-600 p-8 bg-black/50 backdrop-blur-sm shadow-xl shadow-green-900/30">
                        ...
                        <p className="text-lg md:text-xl text-gray-300 mb-8 font-mono">
                            <span className="font-semibold text-green-300">$ Welcome!</span> Construindo infraestruturas robustas.
                        </p>
